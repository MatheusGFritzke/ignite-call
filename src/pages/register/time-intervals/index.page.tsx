...
import { converTimeStringToMinutes } from '@/src/utils/conver-time-string-to-minutes'
...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine(
      ...
      {
        message:
          'O horário de término deve ser pelo menos 1 hora depois do horário de início.',
      },
    ),
})
